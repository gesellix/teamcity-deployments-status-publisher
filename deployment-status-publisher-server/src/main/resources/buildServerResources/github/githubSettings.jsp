...
<jsp:useBean id="keys" class="de.gesellix.teamcity.deployments.server.github.ui.UpdateChangesConstants"/>
    ...
    <tr>
      ...
      <td>
        ...
        <span class="smallNote">
            ...
            <span id="note_personal_token">GitHub <a href="https://github.com/settings/tokens" target="_blank">Personal Access Token</a></span>
            <br />
