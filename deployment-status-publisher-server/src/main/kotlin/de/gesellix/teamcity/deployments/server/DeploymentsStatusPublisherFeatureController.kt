...
class DeploymentsStatusPublisherFeatureController(
  ...
  private val resourceUrl: String = descriptor.getPluginResourcesPath("deploymentsStatusPublisherFeature.html")
  ...
  override fun doHandle(request: HttpServletRequest, response: HttpServletResponse): ModelAndView {
    ...
    var settings: DeploymentsStatusPublisherSettings? = null
    if (publisherId != null) {
  ...
  private fun createEditPublisherModel(publisherId: String): ModelAndView {
    ...
    val publisherSettings: DeploymentsStatusPublisherSettings? = publisherManager.findSettings(publisherId)
