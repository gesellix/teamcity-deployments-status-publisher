...
import static de.gesellix.teamcity.deployments.server.ConstantsKt.TEST_CONNECTION_PARAM;
import static de.gesellix.teamcity.deployments.server.ConstantsKt.TEST_CONNECTION_YES;
import static org.assertj.core.api.BDDAssertions.then;

@Test
public class PublisherSettingsControllerTest extends DeploymentsStatusPublisherTestBase {
  ...
  public void must_test_for_all_relevant_roots() throws Exception {
    HttpServletRequest request = new MockRequest(
      PUBLISHER_ID_PARAM, MockPublisherSettings.PUBLISHER_ID,
      TEST_CONNECTION_PARAM, TEST_CONNECTION_YES,
