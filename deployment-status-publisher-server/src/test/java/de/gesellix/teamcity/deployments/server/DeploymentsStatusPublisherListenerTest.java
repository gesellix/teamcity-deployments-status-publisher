...
@Test
public class DeploymentsStatusPublisherListenerTest extends DeploymentsStatusPublisherTestBase {

  private DeploymentsStatusPublisherListener myListener;
