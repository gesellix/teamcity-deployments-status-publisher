...
public class DeploymentsStatusPublisherProblemsTest extends BaseServerTestCase {
  ...
  private DeploymentsStatusPublisherProblems myProblems;
  private SystemProblemNotificationEngine myProblemEngine;
  private DeploymentsStatusPublisher myPublisher;
  private PublisherLogger myLogger;
  private DeploymentsStatusPublisherSettings myPublisherSettings;
  ...
  public void setUp() throws Exception {
    ...
    myProblems = new DeploymentsStatusPublisherProblems(myProblemEngine);
  ...
  public void must_clear_obsolete_problems() {
    ...
    DeploymentsStatusPublisher publisher2 = new MockPublisher(myPublisherSettings, "PUBLISHER2", myBuildType, FEATURE_2,
