...
@Test
public class DeploymentsStatusPublisherFeatureControllerTest extends DeploymentsStatusPublisherTestBase {
  ...
  public void must_find_attached_vcs_root() throws Exception {
    ...
    final Map<String, String> params = new HashMap<String, String>() {{
      put(PUBLISHER_ID_PARAM, MockPublisherSettings.PUBLISHER_ID);
      put(VCS_ROOT_ID_PARAM, vcsRootId);
    }};
  ...
  public void must_find_attached_vcs_root_by_internal_id() throws Exception {
    ...
    final Map<String, String> params = new HashMap<String, String>() {{
      put(PUBLISHER_ID_PARAM, MockPublisherSettings.PUBLISHER_ID);
      put(VCS_ROOT_ID_PARAM, String.valueOf(vcsRootInternalId));
    }};
  ...
  public void must_be_report_missing_vcs_root() throws Exception {
    ...
    final Map<String, String> params = new HashMap<String, String>() {{
      put(PUBLISHER_ID_PARAM, MockPublisherSettings.PUBLISHER_ID);
      put(VCS_ROOT_ID_PARAM, missingVcsRootId);
    }};
